...
public class P_최대공약수와_최소공배수 {
    public static void main(String[] args) {
        SolutionGratestCommonDivisorAndLeastCommonMultiple sol = new SolutionGratestCommonDivisorAndLeastCommonMultiple();
...
class SolutionGratestCommonDivisorAndLeastCommonMultiple {
